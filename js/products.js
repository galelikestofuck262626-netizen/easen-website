...
function markCards(){document.querySelectorAll(".cf-pcard[data-pid]").forEach(function(a){var on=inCart(a.getAttribute("data-pid"));var b=a.querySelector(".cf-add");if(b){b.classList.toggle("on",on);var lab=b.querySelector(".cf-add-lab");if(lab)lab.innerHTML=on?("✓ "+spans(T.added)):("✦ "+ADD_HTML);}});}
